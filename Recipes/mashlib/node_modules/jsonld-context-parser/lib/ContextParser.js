...
must be one of ${Util_1.Util.CONTAINERS.join(', ')}`, ErrorCoded_1.ERROR_CODES.INVALID_CONTAINER_MAPPING);
    ...
    async parse(context, options = {}) {
        ...
        if (context === null || context === undefined) {
            ...
            let newContext = Object.assign(Object.assign({}, importContext), context);
            if (typeof parentContext === 'object') {
                ...
                newContext = Object.assign(Object.assign({}, parentContext), newContext);
            }
            ...
            if (!ignoreProtection && parentContext && processingMode >= 1.1) {
                this.validateKeywordRedefinitions(parentContext, newContext, JsonLdContextNormalized_1.defaultExpandOptions);
            }
