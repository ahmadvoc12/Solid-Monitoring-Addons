...
var _default = exports["default"] = {
  ...
  render: function render(subject, context) {
    ...
    var _moveOn = function moveOn(current, level) {
            ...
            if (current.uri === contents[i].uri) {
              ...
              if (j === 0) {
                if (!options.chainAlbums) {
                  ...
                  _moveOn(folder, level + 1).then(function (folder2) {
                    if (folder2) {
    ...
    var endedListener = function endedListener(event) {
      ...
      var _tryNext = function tryNext(cur) {
        var current = cur;
        _moveOn(current).then(function (next) {
          if (!next) {
